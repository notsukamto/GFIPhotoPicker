...
//  static private final String  HTTP_AUTHORISATION_FORMAT_STRING      = "Bearer %s";
     ...
     *
     *****************************************************/
    public void getAlbums( Callbacks callback )
    {
     ...
     *
     *****************************************************/
    public void getPhotos( Album album, Callbacks callback )
    {
     ...
     *
     *****************************************************/
    public void getPhoto( String photoId, ImageView targetImageView )
    {
     ...
     *
     *****************************************************/
    private abstract class ARequest<T extends Callbacks>
    {
        T  mCallback;
     ...
     *
     *****************************************************/
    private class AlbumsRequest extends ARequest<Callbacks>
    {
        AlbumsRequest( Callbacks callback )
        {
            super( callback );
        }
     ...
     *
     *****************************************************/
    private class PhotosRequest extends ARequest<Callbacks>
    {
        private Album  mAlbum;


        PhotosRequest( Album album, Callbacks callback )
        {
            super( callback );
     ...
     *
     *****************************************************/
    private class PhotoRequest extends ARequest<Callbacks>
    {
    ...
    private class AlbumsGraphRequestCallback implements GraphRequest.Callback
    {
        ...
        AlbumsGraphRequestCallback( Callbacks callback )
        {
            mCallback = callback;
        }
    ...
    {
        private Album      mAlbum;
        private Callbacks mPhotosCallback;


        PhotosGraphRequestCallback( Album album, Callbacks callback )
        {
            mAlbum          = album;
    ...
    public class Album implements Parcelable
    {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeString(mCoverPhotoId);
        }
    }
    ...
    public class Photo implements Parcelable
    {
        ...
        public final Creator<Photo> CREATOR = new Creator<Photo>() {
            @Override
