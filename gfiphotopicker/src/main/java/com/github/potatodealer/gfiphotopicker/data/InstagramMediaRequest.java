            ...
            protected MediaResponse doInBackground( Void... voids )
            {
                ...
                try
                {
                    ...
                    if ( httpStatusCode == 400 || httpStatusCode == 401 )
                    {
                        ...
                        mediaResponse.error = new InstagramException( InstagramException.CODE_INVALID_ACCESS_TOKEN, null );
                    }
                    else if ( httpStatusCode != 200 )
                    {
                        mediaResponse.error = new InstagramException( InstagramException.CODE_GENERIC_NETWORK_EXCEPTION, GENERIC_NETWORK_EXCEPTION_MESSAGE );
                    }
                    else
                    {
                ...
                catch ( Exception e )
                {
                    ...
                    {
                        e = new InstagramException( InstagramException.CODE_GENERIC_NETWORK_EXCEPTION, GENERIC_NETWORK_EXCEPTION_MESSAGE );
                    }
